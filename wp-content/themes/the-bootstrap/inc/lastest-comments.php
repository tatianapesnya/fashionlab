...
function __construct() {
		$widget_ops = array('classname' => 'widget_recent_comments', 'description' => __( 'The latest commented' ) );
		parent::__construct('latest-comment', __('Latest Comments'), $widget_ops);//titre qui va s'afficher dans le dashboard
		$this->alt_option_name = 'widget_lastest_comments';
		...
		if ( $comments ) {
			...
			foreach ( (array) $comments as $comment) {
				...
				$output .='<li class="recentcomments">
				 	...
				 	$post_title. '</a> '.substr($excerpt, 0,35). '</li>';
			}
 		}
		$output .= '</ul>';
		$output .= $after_widget;
