(function(a){function u(){url=location.href;return hashtag=url.indexOf("#!")!=-1?decodeURI(url.substring(url.indexOf("#!")+2,url.length)):false}function i(f,l){f=f.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var m=RegExp("[\\?&]"+f+"=([^&#]*)").exec(l);return m==null?"":m[1]}a.prettyPhoto={version:"3.1.3"};a.fn.prettyPhoto=function(f){function l(){a(".pp_loaderIcon").hide();projectedTop=scroll_pos.scrollTop+(g/2-c.containerHeight/2);if(projectedTop<0)projectedTop=0;projectedLeft=h/2-c.containerWidth/
2;if(projectedLeft<0)projectedLeft=0;$ppt.fadeTo(settings.animation_speed,1);$pp_pic_holder.find(".pp_content").animate({height:c.contentHeight,width:c.contentWidth},settings.animation_speed);$pp_pic_holder.animate({top:projectedTop,left:projectedLeft,width:c.containerWidth},settings.animation_speed,function(){$pp_pic_holder.find(".pp_hoverContainer,#fullResImage").height(c.height).width(c.width);$pp_pic_holder.find(".pp_fade").fadeIn(settings.animation_speed);isSet&&p(pp_images[set_position])=="image"?
...
50:30;itemsPerPage=Math.floor((c.containerWidth-100-navWidth)/itemWidth);itemsPerPage=itemsPerPage<pp_images.length?itemsPerPage:pp_images.length;totalPage=Math.ceil(pp_images.length/itemsPerPage)-1;if(totalPage==0){navWidth=0;$pp_gallery.find(".pp_arrow_next,.pp_arrow_previous").hide()}else $pp_gallery.find(".pp_arrow_next,.pp_arrow_previous").show();galleryWidth=itemsPerPage*itemWidth;fullGalleryWidth=pp_images.length*itemWidth;$pp_gallery.css("margin-left",-(galleryWidth/2+navWidth/2)).find("div:first").width(galleryWidth+
...
function(){a(".pp_loaderIcon").show();b()})}function A(b){b>1?a(".pp_nav").show():a(".pp_nav").hide()}function e(b,d){resized=false;v(b,d);imageWidth=b;imageHeight=d;if((j>h||k>g)&&doresize&&settings.allow_resize&&!o){resized=true;for(fitting=false;!fitting;){if(j>h){imageWidth=h-200;imageHeight=d/b*imageWidth}else if(k>g){imageHeight=g-200;imageWidth=b/d*imageHeight}else fitting=true;k=imageHeight;j=imageWidth}v(imageWidth,imageHeight);if(j>h||k>g)e(j,k)}return{width:Math.floor(imageWidth),height:Math.floor(imageHeight),
containerHeight:Math.floor(k),containerWidth:Math.floor(j)+settings.horizontal_padding*2,contentHeight:Math.floor(r),contentWidth:Math.floor(w),resized:resized}}function v(b,d){b=parseFloat(b);d=parseFloat(d);$pp_details=$pp_pic_holder.find(".pp_details");$pp_details.width(b);detailsHeight=parseFloat($pp_details.css("marginTop"))+parseFloat($pp_details.css("marginBottom"));$pp_details=$pp_details.clone().addClass(settings.theme).width(b).appendTo(a("body")).css({position:"absolute",top:-1E4});detailsHeight+=
$pp_details.height();detailsHeight=detailsHeight<=34?36:detailsHeight;if(a.browser.msie&&a.browser.version==7)detailsHeight+=8;$pp_details.remove();$pp_title=$pp_pic_holder.find(".ppt");$pp_title.width(b);titleHeight=parseFloat($pp_title.css("marginTop"))+parseFloat($pp_title.css("marginBottom"));$pp_title=$pp_title.clone().appendTo(a("body")).css({position:"absolute",top:-1E4});titleHeight+=$pp_title.height();$pp_title.remove();r=d+detailsHeight;w=b;k=r+titleHeight+$pp_pic_holder.find(".pp_top").height()+
$pp_pic_holder.find(".pp_bottom").height();j=b}function p(b){return b.match(/youtube\.com\/watch/i)||b.match(/youtu\.be/i)?"youtube":b.match(/vimeo\.com/i)?"vimeo":b.match(/\b.mov\b/i)?"quicktime":b.indexOf(".ogv")!=-1?"video":b.indexOf(".mp4")!=-1?"video":b.match(/\b.swf\b/i)?"flash":b.match(/\biframe=true\b/i)?"iframe":b.match(/\bajax=true\b/i)?"ajax":b.match(/\bcustom=true\b/i)?"custom":b.substr(0,1)=="#"?"inline":"image"}function s(){if(doresize&&typeof $pp_pic_holder!="undefined"){scroll_pos=
x();contentHeight=$pp_pic_holder.height();contentwidth=$pp_pic_holder.width();projectedTop=g/2+scroll_pos.scrollTop-contentHeight/2;if(projectedTop<0)projectedTop=0;contentHeight>g||$pp_pic_holder.css({top:projectedTop,left:h/2+scroll_pos.scrollLeft-contentwidth/2})}}function x(){if(self.pageYOffset)return{scrollTop:self.pageYOffset,scrollLeft:self.pageXOffset};else if(document.documentElement&&document.documentElement.scrollTop)return{scrollTop:document.documentElement.scrollTop,scrollLeft:document.documentElement.scrollLeft};
else if(document.body)return{scrollTop:document.body.scrollTop,scrollLeft:document.body.scrollLeft}}function y(){if(settings.social_tools)facebook_like_link=settings.social_tools.replace("{location_href}",encodeURIComponent(location.href));settings.markup=settings.markup.replace("{pp_social}",settings.social_tools?facebook_like_link:"");a("body").append(settings.markup);$pp_pic_holder=a(".pp_pic_holder");$ppt=a(".ppt");$pp_overlay=a("div.pp_overlay");if(isSet&&settings.overlay_gallery){currentGalleryPage=
0;toInject="";for(var b=0;b<pp_images.length;b++){if(pp_images[b].match(/\b(jpg|jpeg|png|gif)\b/gi)){classname="";img_src=pp_images[b]}else{classname="default";img_src=""}toInject+="<li class='"+classname+"'><a href='#'><img src='"+img_src+"' width='50' alt='' /></a></li>"}toInject=settings.gallery_markup.replace(/{gallery}/g,toInject);$pp_pic_holder.find("#pp_full_res").after(toInject);$pp_gallery=a(".pp_pic_holder .pp_gallery");$pp_gallery_li=$pp_gallery.find("li");$pp_gallery.find(".pp_arrow_next").click(function(){a.prettyPhoto.changeGalleryPage("next");
a.prettyPhoto.stopSlideshow();return false});$pp_gallery.find(".pp_arrow_previous").click(function(){a.prettyPhoto.changeGalleryPage("previous");a.prettyPhoto.stopSlideshow();return false});$pp_pic_holder.find(".pp_content").hover(function(){$pp_pic_holder.find(".pp_gallery:not(.disabled)").fadeIn()},function(){$pp_pic_holder.find(".pp_gallery:not(.disabled)").fadeOut()});itemWidth=57;$pp_gallery_li.each(function(d){a(this).find("a").click(function(){a.prettyPhoto.changePage(d);a.prettyPhoto.stopSlideshow();
return false})})}if(settings.slideshow){$pp_pic_holder.find(".pp_nav").prepend('<a href="#" class="pp_play">Play</a>');$pp_pic_holder.find(".pp_nav .pp_play").click(function(){a.prettyPhoto.startSlideshow();return false})}$pp_pic_holder.attr("class","pp_pic_holder "+settings.theme);$pp_overlay.css({opacity:0,height:a(document).height(),width:a(window).width()}).bind("click",function(){settings.modal||a.prettyPhoto.close()});a("a.pp_close").bind("click",function(){a.prettyPhoto.close();return false});
a("a.pp_expand").bind("click",function(){if(a(this).hasClass("pp_expand")){a(this).removeClass("pp_expand").addClass("pp_contract");doresize=false}else{a(this).removeClass("pp_contract").addClass("pp_expand");doresize=true}m(function(){a.prettyPhoto.open()});return false});$pp_pic_holder.find(".pp_previous, .pp_nav .pp_arrow_previous").bind("click",function(){a.prettyPhoto.changePage("previous");a.prettyPhoto.stopSlideshow();return false});$pp_pic_holder.find(".pp_next, .pp_nav .pp_arrow_next").bind("click",
function(){a.prettyPhoto.changePage("next");a.prettyPhoto.stopSlideshow();return false});s()}f=jQuery.extend({animation_speed:"fast",slideshow:5E3,autoplay_slideshow:false,opacity:0.8,show_title:true,allow_resize:true,default_width:500,default_height:344,counter_separator_label:"/",theme:"pp_default",horizontal_padding:20,hideflash:false,wmode:"opaque",autoplay:true,modal:false,deeplinking:true,overlay_gallery:true,keyboard_shortcuts:true,changepicturecallback:function(){},callback:function(){},openLightbox:function(){},
...
a(pp_images[set_position]).html());break;case "video":video_url=pp_images[set_position];filename=video_url.slice(pp_images[set_position],pp_images[set_position].lastIndexOf("."));c=e(movie_width,movie_height);toInject=settings.video_markup.replace(/{width}/g,c.width).replace(/{height}/g,c.height).replace(/{path}/g,filename)}if(!imgPreloader&&!skipInjection){$pp_pic_holder.find("#pp_full_res")[0].innerHTML=toInject;l()}});return false};a.prettyPhoto.changePage=function(b){currentGalleryPage=0;if(b==
"previous"){set_position--;if(set_position<0)set_position=a(pp_images).size()-1}else if(b=="next"){set_position++;if(set_position>a(pp_images).size()-1)set_position=0}else set_position=b;rel_index=set_position;doresize||(doresize=true);a(".pp_contract").removeClass("pp_contract").addClass("pp_expand");m(function(){a.prettyPhoto.open()})};a.prettyPhoto.changeGalleryPage=function(b){if(b=="next"){currentGalleryPage++;if(currentGalleryPage>totalPage)currentGalleryPage=0}else if(b=="previous"){currentGalleryPage--;
...
settings.slideshow)}else a.prettyPhoto.changePage("next")};a.prettyPhoto.stopSlideshow=function(){$pp_pic_holder.find(".pp_pause").unbind("click").removeClass("pp_pause").addClass("pp_play").click(function(){a.prettyPhoto.startSlideshow();return false});clearInterval(n);n=undefined};a.prettyPhoto.close=function(){if(!$pp_overlay.is(":animated")){a.prettyPhoto.stopSlideshow();$pp_pic_holder.stop().find("object,embed").css("visibility","hidden");a("div.pp_pic_holder,div.ppt,.pp_fade").fadeOut(settings.animation_speed,
function(){a(this).remove()});$pp_overlay.fadeOut(settings.animation_speed,function(){a.browser.msie&&a.browser.version==6&&a("select").css("visibility","visible");settings.hideflash&&a("object,embed,iframe[src*=youtube],iframe[src*=vimeo]").css("visibility","visible");a(this).remove();a(window).unbind("scroll.prettyphoto");if(settings.deeplinking){url=location.href;if(hashtag=url.indexOf("#!prettyPhoto")?true:false)location.hash="!prettyPhoto"}settings.callback();doresize=true;q=false;delete settings})}};
if(!pp_alreadyInitialized&&u()){pp_alreadyInitialized=true;hashRel=hashIndex=u();hashIndex=hashIndex.substring(hashIndex.indexOf("/")+1,hashIndex.length-1);hashRel=hashRel.substring(0,hashRel.indexOf("/"));setTimeout(function(){a("a[rel^='"+hashRel+"']:eq("+hashIndex+")").trigger("click")},50)}return this.unbind("click.prettyphoto").bind("click.prettyphoto",a.prettyPhoto.initialize)}})(jQuery);var pp_alreadyInitialized=false;
