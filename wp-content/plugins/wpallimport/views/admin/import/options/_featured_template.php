<tr>
	<td colspan="3">
		...
		<div>
			<input type="text" name="featured_image" style="width:92%;" value="<?php echo esc_attr($post['featured_image']) ?>" />
			<input type="text" class="small" name="featured_delim" value="<?php echo esc_attr($post['featured_delim']) ?>" style="width:5%; text-align:center;"/>
		</div>
		<div class="input">
			<input type="hidden" name="create_draft" value="no" />
			<input type="checkbox" id="create_draft_<?php echo $entry; ?>" name="create_draft" value="yes" <?php echo 'yes' == $post['create_draft'] ? 'checked="checked"' : '' ?> />
		...
		<div>
			...
			<input type="text" class="small" name="atch_delim" value="<?php echo esc_attr($post['atch_delim']) ?>" style="width:5%; text-align:center;"/>
		</div>
		<br>
	</td>
</tr>