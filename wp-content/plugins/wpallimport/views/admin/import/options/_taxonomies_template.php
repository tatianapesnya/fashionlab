													...
													if (is_null($cat->parent_id) or empty($cat->parent_id))
													{
														...
														<li id="item_<?php echo $i; ?>">
															<div class="drag-element">
																...
																<!--input type="checkbox" class="auto_nested" <?php if ($cat->auto_nested): ?>checked="checked"<?php endif; ?> title="<?php _e('Auto nested taxonomies by taxonomies delimiter.','pmxi_plugin');?>"/-->
