			...
			<?php if ($is_loaded_template && !$load_options): ?>
				<form class="options <?php echo ! $this->isWizard ? 'edit' : '' ?>" method="post">
					<span class="load-options">
						<?php _e('Load Options...','pmxi_plugin'); ?>&nbsp;<input type="checkbox" name="load_options" /><a class="help" href="#help" original-title="Load options from selected template.">?</a>
					</span>
				</form>
				<?php elseif ($is_loaded_template): ?>
				<form class="options <?php echo ! $this->isWizard ? 'edit' : '' ?>" method="post">
					<span class="load-options">
						<?php _e('Reset Options...','pmxi_plugin'); ?>&nbsp;<input type="checkbox" name="reset_options" /><a class="help" href="#help" original-title="Reset options.">?</a>
					</span>
				</form>
			<?php endif; ?>
		<?php endif; ?>
